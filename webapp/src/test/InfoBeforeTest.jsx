            ...
            <Grid container justify="center" className={classes.spacing}>
                <Grid item container md={6}>
                    ...
                    <Typography className={classes.spacing}>
                        ...
                        Quibusdam nesciunt iusto nihil aut voluptate omnis ipsa
                        illum dolore similique facilis, non exercitationem saepe
                        quisquam suscipit voluptas architecto officiis veritatis
                        sapiente.
