    ...
    return (
      <Dialog onClose={onClose} open={open} fullWidth>
        ...
        <Typography className={classes.padding}>
          ...
          ratione totam vel architecto eligendi, eos, modi culpa velit omnis
          quibusdam nihil. Numquam at asperiores magni nemo ad repudiandae
        ...
        {liveTest ? (
          <DialogActions>
            <Button component={Link} to="/test-paper/notice">
              Start Test
            </Button>
          </DialogActions>
        ) : (
