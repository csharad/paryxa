            ...
            <Grid container justify="center">
                <Grid item md={8} spacing={16}>
                    ...
                    {questions.map((question, index) =>
                        <Question question={question} index={index} key={index}></Question>)}

                    <Button component={Link} to="/profile">Go To Profile</Button>
                </Grid>
            </Grid>
        );
    }
...
function Answer({ children, isCorrect }) {
    return (
        <ListItem button selected={isCorrect} disabled>
            ...
            {isCorrect ? <ListItemIcon><Icon>check</Icon></ListItemIcon> : ''}
        </ListItem>
    );
}
