...
import { Drawer, List, ListItem, ListItemText, withStyles, Icon, ListItemIcon } from '@material-ui/core';
        ...
        return (
            <Fragment>
                <Drawer variant="permanent" classes={{ paper: classes.drawerPaper }}>
                    <List>
                        ...
                        <ListItem button component={Link} to="/dashboard/new-test">
                            <ListItemIcon><Icon>plus_one</Icon></ListItemIcon>
                ...
                <div className={classes.rightSide}>
                    <Route path="/dashboard/users" component={UserDashboard}></Route>
                    <Route path="/dashboard/tests" component={TestsDashboard}></Route>
                </div>
            </Fragment>
        );
    }
